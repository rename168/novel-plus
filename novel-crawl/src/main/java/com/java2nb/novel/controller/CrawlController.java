...
public class CrawlController {
    ...
    public ResultBean<PageBean<CrawlSource>> listCrawlByPage(@RequestParam(value = "curr", defaultValue = "1") int page,
     ...
     */
    @PostMapping("loadTxt")
    public ResultBean<Void> loadTxt() {

        crawlService.loadTxt();
    ...
    public ResultBean<PageBean<CrawlSingleTask>> listCrawlSingleTaskByPage(
